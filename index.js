...
console.log(color('3'))
console.clear()
console.log(color('=> DenaraBot.js Di Pantau Oleh Kang Bakso'))
console.log(color('=> DenaraBot.js Di Pantau Oleh Kang Bakso'))
console.log(color('=> DenaraBot.js Di Pantau Oleh Kang Bakso'))
CFonts.say(`Denara Online`, {
            font: 'tiny',
            align: 'left',
            gradient: ['red', 'magenta']
        })
console.log(color('=> Source code version:', 'yellow'), color('scwar v1.1', 'cyan'))
console.log(color('=> Bug? Error? Suggestion? Visit here:', 'yellow'), color('6281215626270'))
console.log(color(`${sessionName}.json`), color(`BOT is now online!`, 'red'))
console.log(color('[DEV]', 'cyan'), color('Welcome back, Owner! Hope you are doing well~', 'magenta'))
console.log(color('D', 'green'), color('E', 'red'), color('N', 'yellow'), color('A', 'purple'), color('R', 'blue'),  color('A', 'green'), color('BOT', 'cyan'))
                      console.log(color('SUPPORT by htttps://youtube.com/DenaraBot', 'cyan'))
    const hisoka = hisokaConnect({
        logger: pino({ level: 'silent' }),
        printQRInTerminal: true,
        browser: ['Denara Bot Multi Device','Safari','1.0.0'],
        auth: state
    })
